...
public class ProductClient {
    ...
    public List<PurchaseResponse> purchaseProducts(List<PurchaseRequest> requestBody){
        ...
        HttpEntity<List<PurchaseRequest>> requestEnity = new HttpEntity<>(requestBody, headers);
        ParameterizedTypeReference<List<PurchaseResponse>> responseType =
                new ParameterizedTypeReference<>() {};
        ResponseEntity<List<PurchaseResponse>> responseEntity =
                restTemplate.exchange(productUrl + "/purchase", POST, requestEnity, responseType);
